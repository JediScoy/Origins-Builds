#title: ORIGINS Epilogue
#author: Master Scoy

// VARIABLES for Story Outline
VAR SeasonTitle = "Origins Epilogue"
...
Purpose: to keep INKY from getting confused between each season "S" and episode "Ep" ->SeasonOriginsEpilogue
=== SeasonOriginsEpilogue ===
<h1>{SeasonTitle}</h1>
